...
function serialize_appmap_CreateIndex(arg) {
  if (!(arg instanceof protos_appmap_pb.CreateIndex)) {
    throw new Error('Expected argument of type appmap.CreateIndex');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_appmap_CreateIndex(buffer_arg) {
  return protos_appmap_pb.CreateIndex.deserializeBinary(
    new Uint8Array(buffer_arg)
  );
}
...
var AppMapServiceService = (exports.AppMapServiceService = {
  createIndex: {
    ...
    requestType: protos_appmap_pb.CreateIndex,
    responseType: protos_appmap_pb.Index,
    requestSerialize: serialize_appmap_CreateIndex,
    requestDeserialize: deserialize_appmap_CreateIndex,
  ...
  shutdownIndex: {
    path: '/appmap.AppMapService/shutdownIndex',
    requestStream: false,
    responseStream: false,
    requestType: protos_appmap_pb.Index,
