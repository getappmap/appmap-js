<template>
  <div>
    <div id="intro-details" class="welcome">
      <div class="content">
        <div v-if="currentView === VIEW_COMPONENT">
          <div class="intro">
            <p>
          ...
          <div class="legend">
            <ul>
              <li>
                ...
                <p>Class packages. Right-click to expand them to classes.</p>
              </li>
              <li>
                <div class="icon class"></div>
                <p>Class. Right-click to see source (Ruby only)</p>
              </li>
              <li>
              ...
              <li>
                ...
                <p>Web services/endpoints. Right-click to expand.</p>
              </li>
              <li>
                <div class="icon database"></div>
                <p>Databases that persist application data</p>
              </li>
            </ul>
          </div>
        </div>
        <div v-if="currentView === VIEW_FLOW">
          <div class="intro">
            <p>
              Select a component in the diagram to see its details here. Here,
              we’ll show you any relevant information about your code as you
...
<script>
import { VIEW_COMPONENT, VIEW_FLOW } from '../store/vsCode';
