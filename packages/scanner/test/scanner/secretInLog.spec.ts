...
it('secret in log file', async () => {
  ...
  expect(findings).toHaveLength(2);
  {
    ...
    expect(finding.message).toEqual(
      `Log message contains secret Devise.friendly_token "-6SputWUtvALn3TLCfoYvA": [2f025606-b6f0-4b64-8595-006f32f4d5d0] Started GET "/account_activations/-6SputWUtvALn3TLCfoYvA/edit`
    );
  }
  {
