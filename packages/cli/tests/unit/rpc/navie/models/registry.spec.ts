...
describe(ModelRegistry, () => {
  ...
  describe('list', () => {
    ...
    it('tags the primary model', () => {
      ...
      ModelRegistry.instance.add(model);
      ModelRegistry.instance.select(model);
      expect(ModelRegistry.instance.list()).toStrictEqual([{ ...model, tags: ['primary'] }]);
    });
    it('tags recommended models in priority order', () => {
      ...
      ModelRegistry.instance.add(model);
      expect(ModelRegistry.instance.list()).toStrictEqual([{ ...model, tags: ['recommended'] }]);
    });
    it('tags models that are not recommended', () => {
      ...
      ModelRegistry.instance.add(model);
      expect(ModelRegistry.instance.list()).toStrictEqual([{ ...model, tags: ['alpha'] }]);
    });
    it('can provide more than one tag', () => {
      ...
      expect(ModelRegistry.instance.list()).toStrictEqual([
        { ...model, tags: ['recommended', 'primary'] },
      ]);
    });
  });
