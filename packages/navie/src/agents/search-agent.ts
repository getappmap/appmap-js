...
* [path/to/file1](command:vscode.open?path/to/file1) This file is relevant to the user's question because...
  Some classes, modules, or functions that are relevant to the user's question are...
* [path/to/file2](command:vscode.open?path/to/file2) This file is relevant to the user's question because...
  Some classes, modules, or functions that are relevant to the user's question are...
`;
