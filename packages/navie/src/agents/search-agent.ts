...
* [path/to/file1](path/to/file1) Explanation of the relevance of this file to the user's question.
* [path/to/file2](path/to/file2) Explanation of the relevance of this file to the user's question.
`;
