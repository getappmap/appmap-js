...
- Add EventNavigator#following
  ([50858dd](https://github.com/applandinc/appmap-js/commit/50858ddc22239bccb6bb7b52be001efc35b4a06b))
...
- Handle null value case
  ([7230051](https://github.com/applandinc/appmap-js/commit/7230051851ad8e30f1425175769cf298380ae7cc))
...
- Make EventNavigator.preceding() actually work
  ([64507b8](https://github.com/applandinc/appmap-js/commit/64507b802f3f939d1dd7d61a1aa0a1cc00b1b021))
...
- Tweak stableProperties
  ([54f6ef2](https://github.com/applandinc/appmap-js/commit/54f6ef27ba535a717a33c829e76167f50a04e50b))
...
- Add Event.stableProperties
  ([9db0ea4](https://github.com/applandinc/appmap-js/commit/9db0ea49cc60f438c576704d799ac9711625d254))
...
- Externalized code object id and type
  ([d88b7cd](https://github.com/applandinc/appmap-js/commit/d88b7cd21635d42d437e296dd6338f093f392982))
...
- Handle deep structures in EventNavigator.descendants
  ([a66d768](https://github.com/applandinc/appmap-js/commit/a66d768c913f4a84e2f5362b82dc1db629de0c1e))
...
- Apply eventUpdates when building an AppMap
  ([9cf9989](https://github.com/applandinc/appmap-js/commit/9cf99891e1cdd46c8a58d3030c039ac75e2bce4f))
...
- remove credentials from git repository URLs
  ([#560](https://github.com/applandinc/appmap-js/issues/560))
  ([42cc0f9](https://github.com/applandinc/appmap-js/commit/42cc0f9043a9b2209a1343b2d019141c4044d491))
...
- Normalize HTTP server request path info
  ([#558](https://github.com/applandinc/appmap-js/issues/558))
  ([a130aac](https://github.com/applandinc/appmap-js/commit/a130aac0180600df94a7a4b570f25ec4fa4ecb51))
...
- Normalize SQL strings with backslashes correctly
  ([715bd13](https://github.com/applandinc/appmap-js/commit/715bd13e6136d1496730f82d8a51da08702e7135))
...
- Update SQL parser
  ([8020ec3](https://github.com/applandinc/appmap-js/commit/8020ec3758e98f85d7fb36a040c444017ca98849))
...
- Update sql parser
  ([a69d0d1](https://github.com/applandinc/appmap-js/commit/a69d0d166793c3d7c369634bb07c021693831560))
- When normalizing SQL don't replace comments with a placeholder
  ([e3b2e03](https://github.com/applandinc/appmap-js/commit/e3b2e03f4b9a81cde39d419c98bc7cc41ab35ec7))
...
- Provide Event#requestContentType and #responseContentType
  ([31a6ff3](https://github.com/applandinc/appmap-js/commit/31a6ff37b53e2e58e5561a70a4417ec75416ef1a))
...
- Upgrade SQL parser
  ([da5475e](https://github.com/applandinc/appmap-js/commit/da5475e47cb3943ea83c8380042178f7b289583f))
...
- Improved event hash
  ([5b14997](https://github.com/applandinc/appmap-js/commit/5b14997c53cc692f04dda50465e0933149daabbf))
- SQL event hash falls back on query normalization
  ([735e74c](https://github.com/applandinc/appmap-js/commit/735e74c1baaa7f3e369a3fbbcdf645de0f2fc73f))
...
- Specify event constructor type definition
  ([dacf26d](https://github.com/applandinc/appmap-js/commit/dacf26dc7b74d6bc0ba41fbea2ea17b18b01843a))

### Features

- Callback function on SQL parse error
  ([1ca4f53](https://github.com/applandinc/appmap-js/commit/1ca4f5314f8c0c82d6c37378517048a486426bdc))
...
- descandants performs DFS traversal
  ([ae136cb](https://github.com/applandinc/appmap-js/commit/ae136cb669283534b9073e273f798ad0803e88ae))
...
- Add detailed types for Metadata and SqliteParser
  ([2b74363](https://github.com/applandinc/appmap-js/commit/2b74363cbcecfa50bbc942a20c85da8d9af745d9))
- Use SqliteParser types
  ([75982aa](https://github.com/applandinc/appmap-js/commit/75982aab2c9a37aa254de50ef0e53c6b674ddbea))
...
- Export type definitions
  ([bfee7ec](https://github.com/applandinc/appmap-js/commit/bfee7ec72ba63044dd82751c877b74348ebd8e88))
...
- Use @appland/sql-parser
  ([a9335a7](https://github.com/applandinc/appmap-js/commit/a9335a7273f54c6039875270c3ea11f5b57f2333))
...
- Correctly parse some PostgreSQL-specific constructs
  ([52e0706](https://github.com/applandinc/appmap-js/commit/52e070676405ed4567b802a347f386fec4974651))
...
- Fix hash generation for events without parameters/labels
  ([703be7d](https://github.com/applandinc/appmap-js/commit/703be7d9cb8264c57202af2629179d9f2540deac))
...
- expose function to build query AST
  ([29785e9](https://github.com/applandinc/appmap-js/commit/29785e91138182f9f927178b625be40da541d778))
...
- add missing `elapsedTime` method to `Event`
  ([3f5b122](https://github.com/applandinc/appmap-js/commit/3f5b12274683a3f028151ef94f41f0f60827963c))
...
- Move rollup dependencies to development
  ([7fbaae6](https://github.com/applandinc/appmap-js/commit/7fbaae69895307c1429ad764727d1f3bacd88181))
...
- Properly normalize 'pragma' query
  ([1f3b05d](https://github.com/applandinc/appmap-js/commit/1f3b05dbfd871e4446d5d2a8bfcf40474aedbb7f))
- Separately report query parse and analysis problems
  ([5121cb9](https://github.com/applandinc/appmap-js/commit/5121cb99809cf96b4f908c21419f22d60d01f841))

### Features

- Include event.depth property
  ([f1f8ee8](https://github.com/applandinc/appmap-js/commit/f1f8ee81ebea8b9e3b8783a22bc999219b1b2e50))
...
- Event#dataObjects was missing message objects from its return value
  ([ade2c31](https://github.com/applandinc/appmap-js/commit/ade2c31f316284a7232d914ba4fcec8b2c1ca4c7))
- Prevent access of non-array event messages
  ([15a9cc2](https://github.com/applandinc/appmap-js/commit/15a9cc2efce41451b83e2c35285de1644016fe3d))
...
- Test if an event is a regular function
  ([bb162d6](https://github.com/applandinc/appmap-js/commit/bb162d6b6431a4888872335c6eec5cf975b067bb))
...
- Optimize performance and behavior of ClassMap.bindEvents
  ([5bac5bd](https://github.com/applandinc/appmap-js/commit/5bac5bd90c1cc15ca05ff2d7920e9f17483f9dd4))
...
- Resolve an incorrect import of sha256 ([#227](https://github.com/applandinc/appmap-js/issues/227))
  ([fc64ff9](https://github.com/applandinc/appmap-js/commit/fc64ff981046b5e1732b088889202f32924c407d))
