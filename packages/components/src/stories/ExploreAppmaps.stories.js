import ExploreAppmaps from '@/pages/ExploreAppmaps.vue';

export default {
  title: 'Pages/VS Code/Install Guide Pages',
  component: ExploreAppmaps,
  args: {
    projects: [
      {
        name: 'TestApp',
...
export const exploreAppmaps = (args, { argTypes }) => ({
  props: Object.keys(argTypes),
  components: { ExploreAppmaps },
  template: '<ExploreAppmaps v-bind="$props" ref="installAgent" />',
});
