<template>
  <div :class="classes" :style="styles">
    ...
    <v-trace-node
      :event="event"
      :filtered="eventFilterMatches.has(event)"
      :highlight="selectedEvents.includes(event) || event === eventFilterMatch"
...
export default {
  ...
  computed: {
    ...
    selectedEvents() {
      ...
      return selectedObject instanceof Event ? [selectedObject] : [];
    },
    isExpanded() {
      return (
        this.expanded ||
