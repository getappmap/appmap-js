...
export default {
  ...
  computed: {
    ...
    // what is displayed to the user. This is meant to simplify UI conditions,
    // e.g., replacing conditions like `!isLoading && !isGiantAppMap && !isEmptyAppMap`.
    //
    //
    ...
    state() {
      const [[state]] = Object.entries({
        ...
        DATA_TOO_LARGE: this.isGiantAppMap,
        DATA_EMPTY: this.isEmptyAppMap,
        READY: true,
