...
describe('components/chat/CodeSelection.vue', () => {
  ...
  it('renders defaults', async () => {
    const wrapper = mount(VCodeSelection, { props: { content } });
  ...
  it('properly formats unix paths', () => {
    const wrapper = mount(VCodeSelection, {
      props: { content, uri: URI.file('/app/controllers/users_controller.rb').toString() },
    });
  ...
  it('properly formats Windows paths', () => {
    const wrapper = mount(VCodeSelection, {
      props: { content, uri: URI.file('C:\\app\\controllers\\users_controller.rb').toString() },
    });
  ...
  it('properly formats paths with no separator', () => {
    const wrapper = mount(VCodeSelection, {
      props: { content, uri: URI.file('users_controller.rb').toString() },
    });
  ...
  it('renders line numbers', () => {
    const wrapper = mount(VCodeSelection, {
      props: { content, uri: URI.file('users_controller.rb', { start: 1, end: 3 }).toString() },
    });
  ...
  it('renders a single line number', () => {
    const wrapper = mount(VCodeSelection, {
      props: { content, uri: URI.file('users_controller.rb', { start: 1 }).toString() },
    });
  ...
  it('does not render line numbers without a starting line', () => {
    const wrapper = mount(VCodeSelection, {
      props: { content, uri: URI.file('users_controller.rb', { end: 1 }).toString() },
    });
  ...
  it('does not raise an error if the language is unknown', () => {
    const wrapper = mount(VCodeSelection, { props: { content, language: '????' } });
    expect(wrapper.find('.hljs-keyword').exists()).toBe(false);
  });

  it('uses the provided language for syntax highlighting', () => {
    const wrapper = mount(VCodeSelection, { props: { content, language: 'ruby' } });
    expect(wrapper.find('.hljs-keyword').exists()).toBe(true);
  });
