...
After completing the install steps, you can now [configure the LLM provider](/docs/using-navie-ai/choose-llm-provider) you wish to use with Navie.

### Open a Navie Chat

After configuring your chosen LLM provider, follow the [getting started instructions](/docs/using-navie-ai/navie-opening) to open a new Navie chat window.  
